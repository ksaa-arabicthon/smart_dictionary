...
def load_gensim_models():
    gensim_model1 = gensim.models.Word2Vec.load('full_uni_cbow_100_wiki/full_uni_cbow_100_wiki.mdl')
...
def handle_rating():
    ...
    # Radio buttons
    feature_option = st.radio("", ["***المدلول العكسي***", "***المدلول المعجمي***", "***النظير الكلمي***", "***النظير العامي***", "***الأصيل الكلمي***", "***الدّارج الكلمي***", "***البحث بالقوافي***"])
...
def main():
    ...
    """
    # Display the centered button in Streamlit's sidebar
    st.sidebar.markdown(centered_button_html, unsafe_allow_html=True)
    st.sidebar.markdown('''
